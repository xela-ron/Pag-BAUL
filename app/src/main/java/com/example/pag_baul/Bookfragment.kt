...
class BookFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // 3. UPDATE BUTTON TEXTS BASED ON BOOK ID
        updateButtonLabels(view)

        // 4. SETUP STATION BUTTONS CLICK LISTENERS
    ...
    // --- NEW FUNCTION TO CHANGE BUTTON TEXT ---
    private fun updateButtonLabels(view: View) {
        val btn1 = view.findViewById<Button>(R.id.btnStation1)
        val btn2 = view.findViewById<Button>(R.id.btnStation2)
        val btn3 = view.findViewById<Button>(R.id.btnStation3)
        val btn4 = view.findViewById<Button>(R.id.btnStation4)
        val btn5 = view.findViewById<Button>(R.id.btnStation5)
        // Stations 6-10 are always Essay, so we might keep them generic or specific if needed

        when (currentBookId) {
            1 -> {
                btn1.text = "Station 1: Story Dice"
                btn2.text = "Station 2: ANG YAMAN NG MAGULANG"
                btn3.text = "Station 3: Q&A"
                btn4.text = "Station 4: GAMES"
                btn5.text = "Station 5: Emotion Chart"
            }
            2 -> {
                btn1.text = "Station 1: 4Pics 1 Word"
                btn2.text = "Station 2: SI TAGAK AT SI KALABAW"
                btn3.text = "Station 3: Q&A"
                btn4.text = "Station 4: 4Pics 1 Word"
                btn5.text = "Station 5: Emotion Chart"
            }
            3 -> {
                btn1.text = "Station 1: Word Search"
                btn2.text = "Station 2: ANG MABAIT NA JEEP"
                btn3.text = "Station 3: Q&A"
                btn4.text = "Station 4: GAMES"
                btn5.text = "Station 5: Emotion Chart"
            }
            4 -> {
                btn1.text = "Station 1: PUMILI NG ISDA"
                btn2.text = "Station 2: ANG ISINUMPANG ISDA"
                btn3.text = "Station 3: Q&A"
                btn4.text = "Station 4: GAMES"
                btn5.text = "Station 5: Emotion Chart"
            }
            5 -> {
                btn1.text = "Station 1: Find the way"
                btn2.text = "Station 2: ANG KABAYO AT ANG LEON"
                btn3.text = "Station 3: Q&A"
                btn4.text = "Station 4: GAMES"
                btn5.text = "Station 5: Emotion Chart"
            }
